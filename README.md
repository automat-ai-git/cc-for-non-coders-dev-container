...
- **Слайды всех пяти занятий** — PDF в `course/sessions/0X-*/slides/`.
...
├── course/                 # Материалы курса (5 сессий, 33 демо-проекта, слайды занятий)
...
Курс «Claude Code: суперсила для НЕпрограммистов» — проект [Automatica](https://automatica.io).
Автор и преподаватель — Антон Вдовиченко.

Слайды, демо-проекты и данные выложены открыто: их можно смотреть, запускать у себя и
разбирать вместе с записями занятий. Данные во всех демо вымышленные — компании, суммы,
контакты и переписка сгенерированы для учебных задач и не относятся к реальным людям
и организациям.

Если берёте материалы за основу для своих занятий или публикаций, поставьте ссылку на
источник. Навыки в `skills/` — сторонние, у каждого свой `LICENSE.txt`; на них условия
их авторов, а не эти.
