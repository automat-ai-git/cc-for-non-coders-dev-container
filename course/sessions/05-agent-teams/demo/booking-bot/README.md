...
- **GLM 5:** 12–18 минут (агенты медленнее согласовывают формат данных, иногда нужен повторный промпт)
...
**Агенты работают медленно (дольше 20 минут).** Проверьте, не застряли ли они в цикле согласования. Если два агента бесконечно обсуждают формат данных, вмешайтесь: «Используйте ISO 8601 для дат и имена мастеров как строки. Продолжайте.» Если GLM 5 работает слишком медленно, покажите разницу на Claude Opus 4.6 с тем же промптом.
