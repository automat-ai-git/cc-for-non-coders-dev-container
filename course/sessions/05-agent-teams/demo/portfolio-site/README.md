...
- **GLM 5:** 10–15 минут (верстальщик иногда начинает раньше, чем копирайтер закончит; с GLM это проявляется чаще, и может потребоваться повторный промпт)
...
**GLM 5 генерирует менее структурированный HTML.** Если вёрстка выглядит сырой, попробуйте добавить: «Верстальщик, используй CSS Grid или Flexbox для карточек. Минимальный стиль: шрифт, отступы, цвета.»
