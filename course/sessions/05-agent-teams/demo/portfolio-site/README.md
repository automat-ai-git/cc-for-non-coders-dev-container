...
```
Создай agent team и одностраничный сайт-портфолио для консалтинговой компании. Исходные данные — в файле services-and-cases.md.
...
**HTML получается недостаточно структурированным.** Добавьте: «Верстальщик, используй CSS Grid или Flexbox для карточек. Минимальный стиль: шрифт, отступы, цвета.»
