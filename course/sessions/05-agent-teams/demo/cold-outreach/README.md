...
- **Claude (Opus 4.8):** 6–10 минут
- **GLM 5.2:** 10–15 минут (оценка для планирования; проверьте перед занятием на выданном тарифе)
...
Создай agent team и распредели работу между teammates. Если кто-то найдёт удачный заход или формулировку — пусть поделится с остальными.
...
**Письма получаются недостаточно персонализированными.** Добавьте в промпт: «Обязательно используй конкретный факт из колонки recent_news в каждом письме.»
