...
- Tavily возвращает не ссылки, а извлечённый текст со страниц
...
- Если настройка OAuth слишком долгая на занятии — покажите на своём экране и переходите к следующему демо
...
**Ожидаемый результат:** Claude покажет список из трёх серверов и подтвердит, что каждый доступен.
...
- Проверьте, что не включён корпоративный VPN, блокирующий OAuth
